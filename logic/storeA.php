    ...
    if(isset($_POST['submit'])) {
        ...
        if(!empty($_POST['plate_no'] && $_POST['po_no'])) {
            ...
            if($number_of_rows>0) {
                ...
                $query1 = "INSERT INTO mg_po_turnaroundtime(PO_NBR, SUPP_PLATE_NO, STORE_ARRRIVAL_DATE, ORIG_APPROVAL_DATE, PO_LOCATION) VALUES('$po_number', '$plateNo', sysdate, '$orig_approv_date', '$po_location')";
